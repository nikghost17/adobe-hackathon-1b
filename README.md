...
└── requirements.txt           // Defines the necessary requirements needed to run the project
````
---
...
- Install all the necessary requirements from the requirements.txt using the **pip install** command.
